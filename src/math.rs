...
mod tests {
    ...
    fn test_scalar_to_decimal_roundtrip() {
        let original = "35027840177330064405683178523079910253772859809146826320797401203281604260438";
    ...
    fn test_recover_private_key_real_tx() {
        ...
        assert_eq!(result1, expected, "Signature 1 should recover the private key");
        assert_eq!(result2, expected, "Signature 2 should recover the same private key");
    }
    
    #[test]
    fn test_parse_scalar_rejects_z_ge_n() {
        let n_decimal = "115792089237316195423570985008687907852837564279074904382605163141518161494337";
